...
const Youtube1 = ({ ShowAudiovisuelsApi }) => {
  ...
  return (
        ...
        <Typography variant="body1">
         <iframe
              width="1200"
              height="1200"
              src={`https://www.youtube.com/embed/${extractVideoID(firstActiveAudiovisuel.youtubeLink)}`}
...
export default connect(null, { ShowAudiovisuelsApi })(Youtube1);