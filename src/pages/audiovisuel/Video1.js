...
const Video1 = ({ ShowAudiovisuelsApi }) => {
  ...
  return (
        ...
        <Typography variant="body1">
          ...
          <video controls style={{ width: '100%' }}>
            <source src={firstActiveAudiovisuel.googleDriveVideoUrl} type="video/mp4" />
...
export default connect(null, { ShowAudiovisuelsApi })(Video1);