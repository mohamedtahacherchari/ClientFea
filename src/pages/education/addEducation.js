...
import { addEducationApi } from "../../redux/actions/education/educationsAction";
...
const AddEducation = ({addEducationApi, error}) => {
    ...
    const uploadFileHandler = async (education, fileType) => {
      const file = education.target.files[0];
...
export default connect(mapStateToProps , {addEducationApi})(AddEducation)