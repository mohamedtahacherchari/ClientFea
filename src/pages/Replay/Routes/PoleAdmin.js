...
import AtefImage from '../../../image/poleAdmin.PNG';
  ...
  return (
    <Grid container spacing={2} alignItems="center">
      ...
      <Grid item xs={12} sm={8}>
        <Typography variant="h6">Séminaire FEA(1h25 à 1h40)</Typography>
        <Typography variant="body1">
          <EventIcon /> Date de l'intervention: 13 juin 2020
        </Typography>
        <Typography variant="body1">Intervenant: Hamou,Rachid</Typography>
        <Typography variant="body1">
