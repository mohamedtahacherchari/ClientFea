...
import AtefImage from '../../../image/e-learning.PNG';
  ...
  return (
    <Grid container spacing={2} alignItems="center">
      ...
      <Grid item xs={12} sm={8}>
        <Typography variant="h6">Séminaire FEA(50 à 1h25min)</Typography>
        <Typography variant="body1">
          <EventIcon /> Date de l'intervention: 13 juin 2020
        </Typography>
        <Typography variant="body1">Intervenant: Raphael</Typography>
        <Typography variant="body1">
