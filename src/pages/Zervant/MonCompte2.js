    ...
    <ThemeProvider theme={dark ? darkTheme : lightTheme}>
        ...
        <CssBaseline />
            ...
            >
                ...
                <Route path='myprofile/dashboard' element={<Dashboard/>} />
					<Route path='myprofile/candidats' element={<Candidat/>} />
                    <Route path='myprofile/candidats/add' element={<AddCandidat/>} />
					<Route path='/myprofile/clients' element={<Client/>} />
					<Route path='/myprofile/process' element={<Process data={user}/>} />
					<Route path='/myprofile/settings' element={<Setting/>} />
					<Route path='/myprofile/tasks' element={<Task/>} />
					<Route path='/myprofile/users' element={<User/>} />
					<Route path='/myprofile/editprofile' element={<EditProfile/>} />
					<Route path='/myprofile/report' element={<Report/>}/>
                    <Route path='/myprofile/jobs' element={<Jobs/>} />
                    <Route path='/myprofile/jobs' element={<Jobs/>} />
                    <Route path='/myprofile/Mail1' element={<Mail1/>} />
                    <Route path='/myprofile/Mail2' element={<Mail2/>} />
                    <Route path='/myprofile/Mail3' element={<Mail3/>} />
                    <Route path='/myprofile/FormDialog' element={<FormDialog/>} />
                    <Route path="/myprofile/edit_user/:id" element={<EditUser/>} exact/>
