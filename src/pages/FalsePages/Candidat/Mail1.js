...
<h1>hello</h1>
 <h1>   MAIL CONFIRMATION ENTRETIEN LOCAUX CLIENT :</h1>
...
Comme convenu, je vous confirme votre entretien pour le poste <input placeholder="d’Ingénieur DevOps"/></p>
<p style={{marginRight :"110px"}}>
qui aura lieu <input style={{fontWeight: "bold"}}  placeholder="ce mercredi 15 septembre "/>chez<input style={{fontWeight: "bold"}} placeholder=" NOMCLIENT :"/>
</p>
<p style={{marginRight :"110px"}}>
<input style={{fontWeight: "bold",}} placeholder="- à 16h30 "/>avec Guillaume Michel (Manager de l’équipe)</p>
<p style={{marginRight :"50px"}}>
L’entretien aura lieu dans les locaux de la société NOMCLIENT au 58, rue Jean</p>
<p style={{marginRight :"370px"}}>Jacques Rousseau – 75010 Paris.</p>
